        ...
        return (
            <div key={`halfDatalists${title1}${title2}`} className={styles.halfinputFieldsContainer}>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Category && <span id='categoryError' className={styles.error}>Please choose a category</span>}
                </div>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Type && <span id='typeError' className={styles.error}>Please choose a Job Type</span>}
                </div>
            </div>
        )
    }
        ...
        return (
            <div key={`dateAndDrop${title}`} className={styles.halfinputFieldsContainer}>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Date && <span id='dateError' className={styles.error}>Please choose a date</span>}
                </div>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Status && <span id='statusError' className={styles.error}>Please choose a status</span>}
                </div>
            </div>
        )
    }
        ...
        return (
            <div key={`halfInputField${title1}${title2}`} className={styles.halfinputFieldsContainer}>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Company && <span id='companyError' className={styles.error}>Please enter a company</span>}
                </div>
                <div className={styles.halfInputField}>
                    ...
                    {errors.Location && <span id='locationError' className={styles.error}>Please enter a location</span>}
                </div>
            </div>
        )
    }
            ...
            <form className={styles.modalContainer}>
                ...
                <div className={styles.inputFieldsContainer}>
                    <div className={styles.singleInputContainer}>
                        ...
                        {errors.Title && <span id='titleError' className={styles.error} style={{marginLeft:'12%'}}>Please enter a title</span>}
                    </div>
                    ...
                    <div className={styles.singleInputContainer}>
                        ...
                        {errors.URL && <span id='urlError' className={styles.error} style={{marginLeft:'12%'}}>Please enter a URL</span>}
                    </div>
